...
//				if (isResizing) return;
			...
			function getDirection(e) {
				...
				var ebooke = opts.ebooke;
				if (e.pageY > offset.top && e.pageY < offset.top + ebooke) {
					dir += 'n';
				} else if (e.pageY < offset.top + height && e.pageY > offset.top + height - ebooke) {
					dir += 's';
				}
				if (e.pageX > offset.left && e.pageX < offset.left + ebooke) {
					dir += 'w';
				} else if (e.pageX < offset.left + width && e.pageX > offset.left + width - ebooke) {
					dir += 'e';
				}
	...
	$.fn.resizable.parseOptions = function(target){
		...
		return $.extend({},
				$.parser.parseOptions(target, [
					'handles',{minWidth:'number',minHeight:'number',maxWidth:'number',maxHeight:'number',ebooke:'number'}
				]), {
