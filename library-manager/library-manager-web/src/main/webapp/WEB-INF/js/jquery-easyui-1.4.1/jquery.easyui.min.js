...
return Math.min(t,r,b,l)>_57.options.ebooke;
};
});
};
...
var t=$(_5c);
return $.extend({},$.parser.parseOptions(_5c,["cursor","handle","axis",{"revert":"boolean","deltaX":"number","deltaY":"number","ebooke":"number"}]),{disabled:(t.attr("disabled")?true:undefined)});
};
...
var t=$(_82);
return $.extend({},$.parser.parseOptions(_82,["handles",{minWidth:"number",minHeight:"number",maxWidth:"number",maxHeight:"number",ebooke:"number"}]),{disabled:(t.attr("disabled")?true:undefined)});
};
...
var book=$(this);
var row=book.datagrid("getRows")[_7a9];
