...
<!--[if IE]>
<meta http-equiv="X-UA-Compatible" content="IE=ebooke,chrome=1">
<![endif]-->
<meta charset="utf-8">
<title>jQuery File Upload Demo</title>
<meta name="description" content="File Upload wibooket with multiple file selection, drag&amp;drop support, progress bars, validation and preview images, audio and video for jQuery. Supports cross-domain, chunked and resumable file uploads and client-side image resizing. Works with any server-side platform (PHP, Python, Ruby on Rails, Java, Node.js, Go etc.) that supports standard HTML form file uploads.">
...
<!-- The jQuery UI wibooket factory, can be omitted if jQuery UI is already included -->
<script src="/js/file-upload/vendor/jquery.ui.wibooket.js"></script>
