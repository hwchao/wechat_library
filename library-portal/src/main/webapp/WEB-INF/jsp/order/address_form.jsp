...
<html>
 ...
 <body>
  ...
  <div class="fill_message"> 
   <p> 选择地址： <select id="address"> <option value="-1"> 填写新地址 </option> </select> </p> 
    ...
    <table class="tab_login"> 
     <tbody>
      <tr> 
       ...
       <td> <input type="text" class="text_input" name="addr.receive_name" id="receiveName" /> 
      ...
      <tr> 
       ...
       <td> <input type="text" name="addr.full_address" class="text_input" id="fullAddress" /> 
      ...
      <tr> 
       ...
       <td> <input type="text" class="text_input" name="addr.postal_code" id="postalCode" /> 
      ...
      <tr> 
       ...
       <td> <input type="text" class="text_input" name="addr.phone" id="phone" /> 
        <div class="text_left" id="phoneValidMsg"> 
         <p> 请填写有效的收件人的电话<span style="color:green">&nbsp;&nbsp;&nbsp;选填项</span> </p> 
        </div> </td> 
      </tr> 
      <tr> 
       <td valign="top" class="w1"> 手机 </td> 
       <td> <input type="text" class="text_input" name="addr.mobile" id="mobile" /> 
        <div class="text_left" id="mobileValidMsg"> 
         <p> 请填写有效的收件人的手机<span style="color:green">&nbsp;&nbsp;&nbsp;选填项</span> </p> 
        </div> </td> 
      </tr> 
     </tbody>
    </table> 
    <div class="login_in"> 
     <a href="confirm"><input id="btnClientRegister2" class="button_1" name="submit" type="button" value="取消" /></a> 
     <input id="btnClientRegister" class="button_1" name="submit" type="submit" value="下一步" /> 
    </div> 
   </form> 
  </div> &lt;%@include file=&quot;/common/foot1.jsp&quot;%&gt;   
  <!--
