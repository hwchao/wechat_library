...
<link href="${pageContext.request.contextPath}/css/secBook_Show.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/css/shopping_vehicle.css"
	rel="stylesheet" type="text/css" />
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/jquery-1.4.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/cart.list.js"></script>
</head>
<body>
	<br />
	<br />
			...
			<table class="tabl_buy" id="tbCartItemsNormal">
				...
				<s:iterator value="ciBuy" var="ci">
					<tr class='td_no_bord'>
						...
						<td><a href="http://localhost:8080/dangdang/main/book_view?id=${ci.pro.id }">${ci.pro.product_name }</a></td>
						<td><a href="http://localhost:8080/dangdang/main/book_view?id=${ci.pro.id }"><IMG
								id=img_show_prd src="../productImages/${ci.pro.product_pic }"
								width="75px"></td>
						<td class="buy_td_5"><span class="c_gray">${ci.pro.fixed_price}</span>
						</td>
						<td class="buy_td_4">&nbsp;&nbsp; <span>￥${ci.pro.dang_price}</span>
						</td>

						<td class="buy_td_1">&nbsp;&nbsp;${ci.num }</td>

						<td><input class="del_num" type="text" size="3"
							maxlength="4" /> <a href="cart!modify?id=${ci.pro.id }&num=">变更</a>
						</td>
			...
			<div class="choice_balance">
				...
				<div class="total_balance">
					<div class="save_total">
						您共节省： <span class="c_red"> ￥<span id="total_economy"><c1:retainTwo /></span>
						</span> <span id='total_vip_economy' class='objhide'> ( 其中享有优惠： <span
							class="c_red"> ￥<span id='span_vip_economy'><c1:retainTwo /></span>
						</span> )
			...
			<tbody>
				...
				<s:iterator value="ciDel" var="cDel">
					<tr>
						...
						<td width="365" class=t2><a href="#">${cDel.pro.product_name }</a>
						</td>
						<td width="106" class=buy_td_5>￥${cDel.pro.fixed_price }</td>
						<td width="134" class=buy_td_4><span>￥${cDel.pro.dang_price }</span>
						</td>
						<td width="56" class=buy_td_1><a
							href="cart!recovery?id=${cDel.pro.id }">恢复</a></td>
